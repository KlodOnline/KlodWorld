...
class Unit extends Locatable
{
    ...
    {
        return (int) $this->getJsonData('unit_type');
    }
    public function getCityId()
    {
        return (int) $this->getJsonData('city_id');
    }
    public function getMoral()
    {
        return (int) $this->getJsonData('moral');
    }
    public function getBoat()
    {
        return (bool) $this->getJsonData('boat');
    }
    ...
    public function getUnitTypeMovement()
    {

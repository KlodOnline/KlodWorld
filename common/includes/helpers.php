...
{
    if (floor($memInt / 1000000000) > 0) {
        return floor($memInt / 1000000000).'Go';
    }
    if (floor($memInt / 1000000) > 0) {
        return floor($memInt / 1000000).'Mo';
    }
    if (floor($memInt / 1000) > 0) {
        return floor($memInt / 1000).'Ko';
    }

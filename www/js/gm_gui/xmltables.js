        ...
        if (className !== 'simple') {
          ...
          $(this)
            ...
            .each(function () {
              ...
              if (complexName !== '' && complexValue !== '') {
                itemXML += `<${complexName}>${complexValue}</${complexName}>`
              }
            })
          itemXML += `</${header}>`
        } else {
...
function addItem() {
  ...
  table.querySelectorAll('thead th').forEach((th) => {
    ...
    cell.appendChild(
      columnType === 'simple' ? simpleContentCell() : complexeContentCell(columnType)
    )
